...
class LoadQt(QMainWindow):
    ...
    def open_img(self):
        fname, filter = QFileDialog.getOpenFileName(self, 'Open File', 'C:\\', "Image Files (*)")
        if fname:
    ...
    def AboutMessage(self):
        QMessageBox.about(self, "About Qt - Qt Designer",
            "Qt is a multiplatform C + + GUI toolkit created and maintained byTrolltech.\n"
    ...
    def AboutMessage2(self):
        QMessageBox.about(self, "About Author", "Created by Danit Consultancy and Development")

    # ------------------------------------------------------------------------------------------------------------

    def QuestionMessage(self):
        message = QMessageBox.question(self, "Exit", "Are you sure you wish to exit?", QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
